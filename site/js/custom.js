...
$(window).scroll(function(){
	if($(window).scrollTop() > 600) {
		...
		// $('.ribbon-vagas').animate({opacity:0},1000);
		// $('.ribbon-image').addClass('com-menu');
		// $('.ribbon-treinamentos').addClass('com-menu');
	}
	else {
		$('.navbar-default').fadeOut(300);
		// $('.ribbon-image').removeClass('com-menu');
		// $('.ribbon-treinamentos').removeClass('com-menu');
	}
